...
if (!defined('OLE_FUNCTIONS')) {
    define('OLE_FUNCTIONS', true);

    define('ole_mb_encodings', array(
        1200 => 'UTF-16LE',
        1201 => 'UTF-16BE',
        1251 => 'CP1251',
        1252 => 'CP1252'
    ...
    function ole_convert_encoding($str, $codepage = 1252)
    {
        if (isset(ole_mb_encodings[$codepage]))
            $out = mb_convert_encoding($str, 'UTF-8', ole_mb_encodings[$codepage]);
